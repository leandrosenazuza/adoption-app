...
export class DadosReadDataSource extends DataSource<Dados> {
  data: Dados[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Dados[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Dados[]) {
